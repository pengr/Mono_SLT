#!/bin/bash
cd ~/mono_slt
CUDA_VISIBLE_DEVICES=0 python train.py ../data/multi_domain/gloss_en/bt \
...
--weight-decay 0.0 --max-tokens 2048 --save-dir ../checkpoints/multi_domain/gloss_en/bt --update-freq 3 --no-progress-bar --log-format json \
