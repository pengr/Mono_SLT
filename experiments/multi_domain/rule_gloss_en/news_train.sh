#!/bin/bash
cd ~/mono_slt
CUDA_VISIBLE_DEVICES=0 python train.py ../data/multi_domain/gloss_en/rule_news \
...
--weight-decay 0.0 --max-tokens 2048 --save-dir ../checkpoints/multi_domain/gloss_en/rule_news --update-freq 3 --no-progress-bar --log-format json \
