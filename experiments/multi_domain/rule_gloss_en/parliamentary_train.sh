#!/bin/bash
cd ~/mono_slt
CUDA_VISIBLE_DEVICES=0 python train.py ../data/multi_domain/gloss_en/rule_parliamentary \
...
--weight-decay 0.0 --max-tokens 2048 --save-dir ../checkpoints/multi_domain/gloss_en/rule_parliamentary --update-freq 3 --no-progress-bar --log-format json \
--log-interval 50 --save-interval-updates 1000 --keep-interval-updates 1 --max-update 200000 \
--patience 5
