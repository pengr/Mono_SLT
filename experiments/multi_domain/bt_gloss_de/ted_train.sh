#!/bin/bash
cd ~/mono_slt
CUDA_VISIBLE_DEVICES=5 python train.py ../data/multi_domain/gloss_de/bt_ted \
...
--weight-decay 0.0 --max-tokens 2048 --save-dir ../checkpoints/multi_domain/gloss_de/bt_ted --update-freq 3 --no-progress-bar \
