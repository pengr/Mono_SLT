#!/bin/bash
cd ~/mono_slt
CUDA_VISIBLE_DEVICES=5 python train.py ../data/multi_domain/gloss_de/rule_mixed \
...
--weight-decay 0.0 --max-tokens 2048 --save-dir ../checkpoints/multi_domain/gloss_de/rule_mixed --update-freq 3 --no-progress-bar \
--log-format json --log-interval 50 --save-interval-updates 100 --keep-interval-updates 1 --max-update 300000 \
--patience 3
