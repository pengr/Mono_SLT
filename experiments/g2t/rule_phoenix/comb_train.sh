#!/bin/bash
cd ~/mono_slt
CUDA_VISIBLE_DEVICES=0 python train.py ../data/phoenix2014T/rule_phoenix/comb \
...
--weight-decay 0.0 --max-tokens 2048 --save-dir ../checkpoints/rule_phoenix/comb --update-freq 3 --no-progress-bar --log-format json \
