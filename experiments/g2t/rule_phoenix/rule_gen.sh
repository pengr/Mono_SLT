...
mkdir -p $WMT14_DIR/rule
cp -f $WMT14_DIR/train.de $WMT14_DIR/rule/train.de
CUDA_VISIBLE_DEVICES=0 python de2gloss.py -input  $WMT14_DIR/rule/train.de -output  $WMT14_DIR/rule/train.gloss \
