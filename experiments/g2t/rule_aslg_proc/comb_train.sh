#!/bin/bash
cd ~/mono_slt
CUDA_VISIBLE_DEVICES=5 python train.py ../data/aslg/rule_aslg_proc/comb \
...
--weight-decay 0.0 --max-tokens 2048 --save-dir ../checkpoints/rule_aslg_proc/comb --update-freq 3 --no-progress-bar --log-format json \
