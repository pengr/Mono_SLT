#!/bin/bash
cd ~/mono_slt
CUDA_VISIBLE_DEVICES=0 python train.py ../data/phoenix2014T/bt_phoenix/comb \
...
--weight-decay 0.0 --max-tokens 2048 --save-dir ../checkpoints/bt_phoenix/comb --update-freq 3 --no-progress-bar --log-format json \
--log-interval 50 --save-interval-updates 100 --keep-interval-updates 1 --max-update 300000 \
--patience 3

#ensemble decoding: --keep-interval-updates 3
